...
CREATE TABLE IF NOT EXISTS medicineAllergy
(
...
CREATE TABLE IF NOT EXISTS equipInfo (
...
CREATE TABLE IF NOT EXISTS medicineDiag (
    medDiagID SERIAL PRIMARY KEY,
    disDiagID INTEGER NOT NULL REFERENCES diseaseDiag(disDiagID) ON DELETE CASCADE,
    icdmID INTEGER NOT NULL REFERENCES icdmCode(icdmID) ON DELETE CASCADE,
    description TEXT
);
...
CREATE TABLE IF NOT EXISTS feedBack (
    ...
    medDiagID INTEGER NOT NULL REFERENCES medicineDiag(medDiagID) ON DELETE CASCADE,
    effectPercentage DECIMAL(3,0)
);
